	...
	<div class="col-sm-9 col-md-10 col-sm-offset-3 col-md-offset-2 main">					
							...
							<td style="width:15%;">
								...
								<td>
									<span class="property-value" 
										...
										<b>
											${citaInstance?.doctor?.nombre.encodeAsHTML()} 
											${citaInstance?.doctor?.apellidoPat.encodeAsHTML()} 
											${citaInstance?.doctor?.apellidoMat.encodeAsHTML()}
										</b>
									</span>
								</td>
							</li>
		...
		<div class="panel-footer">
			...
			<fieldset class="buttons">
				<g:link class="btn btn-info" action="edit" id="${citaInstance.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
